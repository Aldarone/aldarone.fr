...
post_title: >
  ...
  smartphone
author: ""
post_date: 2015-10-16 13:31:52
post_excerpt: ""
layout: post
permalink: http://aldarone.fr/?p=1664
published: false
---
...
Caption : Moi quand je vois ça, je m'en fout parce que j'utilise XPrivacy, mais j'ai de la peine pour les gens qui ne savent pas comment se couvrir.

Ensuite le poids téléchargé est un peu effrayant lui aussi.

Caption : XX Mo pour une appli de messagerie et une autre qui va bêtement appeler une API ? J'imagine que le code espion ça pèse lourd…
...
Caption : Yep, le code espion ça pèse vraiment très lourd en fait.
